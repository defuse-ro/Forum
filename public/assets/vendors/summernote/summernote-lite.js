...
var ModalUI_ModalUI = /*#__PURE__*/function () {
  ...
  /*, options */
    ...
    this.$modal = $node;
    this.$backdrop = external_root_jQuery_commonjs2_jquery_commonjs_jquery_amd_jquery_default()('<div class="modal"/>');
  }
  ...
  ModalUI_createClass(ModalUI, [{
    ...
    key: "hide",
    value: function hide() {
      this.$modal.removeClass('show').hide();
      this.$backdrop.hide();
