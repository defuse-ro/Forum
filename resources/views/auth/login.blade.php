                        ...
                        <div class="card" data-aos="fade-up" data-aos-easing="linear">
                            <div class="card-body p-4 p-xl-5">
                                ...
                                <form id="login_form" method="POST">
                                    ...
                                    <div class="pb-3"><button type="submit" id="login_btn" class="w-100 btn btn-mint">{{ trans('login') }}</button></div>
                                    <div class="text-center"><small>{{ trans('not_registered') }}?</small> <a href="{{ route('auth.register') }}" class="small font-weight-bold">{{ trans('create_an_account') }}</a></div>
                                </form>
