...
@forelse($posts as $post)
    <div class="post-box card d-flex mx-0 {{ $post->solved == '1' ? 'solved' : '' }}" data-aos="fade-up" data-aos-easing="linear">
        ...
        <a href="javascript:void(0)" onclick="delete_item('{{ route('user.bookmarks.destroy') }}','{{ $post->id }}','{{ trans('remove_this_bookmark') }}');" class="remove-icon"><i class="bi bi-x-lg"></i></a>
...
<div class="dashboard-card" data-aos="fade-up" data-aos-easing="linear">
    <div class="dashboard-body">
        <div class="upload-image my-3">
            <h4 class="mb-3">{{ trans('no_bookmarks_available') }}.</h4>
        </div>
