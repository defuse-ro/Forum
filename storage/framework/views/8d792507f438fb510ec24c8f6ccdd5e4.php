...
<?php $__env->startSection('content'); ?>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <ul class="breadcrumbs">
                        ...
                        <li><?php echo e(trans('pricing_plans')); ?></li>
                    </ul>
                    <h2 class="mb-2"><?php echo e(trans('pricing_plans')); ?></h2>
                </div>
            </div>
        </div>
    </div><!--/vine-header-->
            ...
            <?php $__empty_1 = true; $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="col-lg-6 mb-5" data-aos="fade-up" data-aos-easing="linear">
                    <div class="price">
                        ...
                        <?php else: ?>
                            <a href="#sub-dialog" class="btn btn-mint btn-sm rounded-pill has-popup"><i class="bi bi-arrow-repeat me-1"></i><?php echo e(trans('subscribe_now')); ?> / <?php echo e(get_setting('currency_symbol')); ?><?php echo e($plan->price); ?></a>
                        <?php endif; ?>
                    </div>
                </div>
    ...
    <?php else: ?>
        <div id="sub-dialog" class="white-popup zoom-anim-dialog mfp-hide">
                <h4><?php echo e(trans('please_login_to_purchase_plans')); ?>.</h4>
        </div>
    <?php endif; ?>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\projects\Tests\ApexForum\resources\views/frontend/plans.blade.php ENDPATH**/ ?>