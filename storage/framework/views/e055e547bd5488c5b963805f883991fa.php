                        ...
                        <div class="card" data-aos="fade-up" data-aos-easing="linear">
                            <div class="card-body p-4 p-xl-5">
                                <div class="login-header">
                                    ...
                                    <p class="small mb-4">Forgot Password</p>
                                </div>
                                ...
                                <form id="forgot_form" method="POST">
                                    ...
                                    <div class="pb-3"><button type="submit" id="forgot_btn" class="w-100 btn btn-mint">Submit</button></div>
...
<script>
    $(function (){
        $(document).on('submit', '#forgot_form', function (e){
            ...
            $('#forgot_btn').text('Loading...');

            $.ajax({
                url: '<?php echo e(route('auth.forgot')); ?>',
                method: 'post',
                data: fd,
                cache: false,
                contentType: false,
...
<?php echo $__env->make('layouts.login', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\projects\Tests\ApexForum\resources\views/auth/forgot.blade.php ENDPATH**/ ?>