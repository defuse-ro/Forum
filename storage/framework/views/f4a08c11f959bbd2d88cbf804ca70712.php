    ...
    <div class="dashboard-card invoice mb-5" data-aos="fade-up" data-aos-easing="linear">
        <div class="dashboard-body p-0 p-md-4">
                ...
                <div class="col-lg-6 ml-md-auto text-lg-end">
                    ...
                    <p><strong>Invoice Date:</strong><?php echo e(date('d M, Y', strtotime($deposit->created_at))); ?></p>
                </div>
                </div>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        <tr>
                            <td>1</td>
                            <td>Add Funds</td>
                            <td class="text-right"><?php echo e(get_setting('currency_symbol')); ?><?php echo e($deposit->amount); ?></td>
                        </tr>
                    </tbody>
                </table>
                </div>
                ...
                <div class="col-lg-6 text-lg-end">
                    ...
                    Sub Total: <?php echo e(get_setting('currency_symbol')); ?><?php echo e($deposit->amount); ?>

                    <br>
                    Transaction Fee (<?php echo e($deposit->percentage_applied); ?>) : <?php echo e(get_setting('currency_symbol')); ?><?php echo e($deposit->transaction_fee); ?>

                    </span>
                    <p class="text-bold">Total: <span class="tx-20 tx-gray-900"><?php echo e($totalAmount); ?></span></p>
                    <br>
                </div>
                </div>
                <hr>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\projects\Tests\ApexForum\resources\views/user/deposits/invoice.blade.php ENDPATH**/ ?>