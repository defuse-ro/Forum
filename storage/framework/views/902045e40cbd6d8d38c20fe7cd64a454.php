            ...
            <div class="row">
                <div class="col-lg-6">
                    <ul class="breadcrumbs">
                        ...
                        <li><?php echo e(trans('discussions')); ?></li>
                    </ul>
                    <h2 class="mb-2"><?php echo e(trans('discussions')); ?></h2>
                </div>
            </div>
        </div>
        <?php if(Auth::check()): ?>
...
<script>
    ...
    function filterPosts() {
        ...
        let url = "<?php echo e(route('home.posts.sort')); ?>";
        $.ajax({
            type: "get",
            url: url,
            data: {
    ...
    function fetchData(page, category_id, date, sort, search_term) {
        ...
        $.ajax({
            url: "<?php echo e(url('posts/pagination/?page=')); ?>" + page,
            data: {
                'category_id': category_id,
                'date': date,
                'sort': sort,
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\projects\Tests\ApexForum\resources\views/frontend/posts.blade.php ENDPATH**/ ?>