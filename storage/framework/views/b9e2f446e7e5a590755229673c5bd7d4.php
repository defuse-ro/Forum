            ...
            <div class="card-header card-header-action">
                <div class="media align-items-center">
                    ...
                    <div class="media-body">
                        <a href="<?php echo e(route('user', ['username' => $post->user->username])); ?>"><?php echo e($post->user->name); ?> <i class="bi bi-patch-check-fill text-red"></i></a>
...
<div class="dashboard-card" data-aos="fade-up" data-aos-easing="linear">
    <div class="dashboard-body">
        <div class="upload-image my-3">
            <h4 class="mb-3">No Posts available.</h4>
        </div>
...
<?php /**PATH C:\xampp\htdocs\projects\Tests\ApexForum\resources\views/frontend/partials/category.blade.php ENDPATH**/ ?>