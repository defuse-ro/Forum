...
<main class="content">
    ...
    <section class="section">
      ...
      <div class="row mt-50">
        ...
        <div class="col-lg-12">
            <?php if(Route::is('admin.comments.list')): ?>
                <div class="card">
                    <div class="card-header">

                        <div class="d-md-flex justify-content-between align-items-center mb-10">
                            <h5 class="h4 mb-0"><?php echo e(trans('comments')); ?></h5>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $comments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><img src="<?php echo e(my_asset('uploads/users/'.App\Models\User::find($comment->user_id)->image)); ?>" class="img-fluid avatar avatar-rounded me-2" width="40px" height="40px" alt="Image">
                                         <?php echo e(App\Models\User::find($comment->user_id)->name); ?>

                                        </td>
                                        <td><?php echo strip_tags(substr($comment->body, 0, get_setting('maximum_preview_chars'))); ?></td>
                                        <td><a href="<?php echo e(route('home.post', ['post_id' => $comment->post->post_id, 'slug' => $comment->post->slug])); ?>" target="_blank"><?php echo e($comment->post->title); ?></a></td>
                                        <td><?php echo e(date('d M, Y', strtotime($comment->created_at))); ?></td>
                                        <td class="text-right">

                                            <a href="<?php echo e(route('admin.comments.edit', ['id' => $comment->id])); ?>" class="btn btn-soft-success btn-icon btn-circle btn-sm btn icon" title="Edit">
                                                <i class="align-middle" data-feather="edit-2"></i>
                                            </a>
                                            <a href="javascript:void(0)" class="btn btn-soft-danger btn-icon btn-circle btn-sm confirm-delete" title="Delete"
                                            onclick="delete_item('<?php echo e(route('admin.comments.destroy')); ?>','<?php echo e($comment->id); ?>','<?php echo e(trans('delete_this_comment')); ?>?');">
            ...
            <?php elseif(Route::is('admin.comments.edit')): ?>

                <div class="card-style settings-card-2 mb-30">
                    <h4 class="mb-3"><?php echo e(trans('edit_comment')); ?></h4>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="input-style-1">
                                    <label class="form-label"><?php echo e(trans('bodyj')); ?></label>
                            ...
                            <div class="col-12">
                            <button type="submit" id="edit_comment_btn" class="main-btn primary-btn btn-hover"><?php echo e(trans('submit')); ?></button>
                            </div>
                        </div>
...
<script>
    ...
    <?php if(Route::is('admin.comments.edit')): ?>
      <script>
        $(function() {
            ...
            $(document).on('submit', '#edit_comment_form', function(e) {
                ...
                $("#edit_comment_btn").text('<?php echo e(trans('submitting')); ?>...');
                $.ajax({
                    url: '<?php echo e(route('admin.comments.edit', ['id' => $comment->id])); ?>',
                    method: 'post',
                    data: fd,
                    cache: false,
                    contentType: false,
                    ...
                    if (response.status == 400) {
                        ...
                        $("#edit_comment_btn").text('<?php echo e(trans('submit')); ?>');
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\projects\Tests\ApexForum\resources\views/admin/forum/comments.blade.php ENDPATH**/ ?>