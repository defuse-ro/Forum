...
<h4 class="mb-0" data-aos="fade-down" data-aos-easing="linear"><i class="bi bi-plus-circle-dotted me-2"></i> <?php echo e(trans('add_post')); ?></h4>
                ...
                <form id="addpost_form" method="POST">
                    <div class="row g-3">
                        <div class="col-sm-12">
                            ...
                            <input type="text" name="title" id="title" placeholder="<?php echo e(trans('title')); ?>">
                            <div class="invalid-feedback"></div>
                        </div>
                        <div class="col-sm-12">
                            <label class="form-label"><?php echo e(trans('description')); ?></label>
                            <textarea name="description" id="description" rows="4" placeholder="<?php echo e(trans('description')); ?>"></textarea>
                            <div id="count"><?php echo e(trans('characters')); ?>: 400 </div>
                            <div class="invalid-feedback"></div>
                        </div>
                        <div class="col-sm-12">
                            <label class="form-label"><?php echo e(trans('keywords')); ?></label>
                            <input type="text" name="keywords" id="keywords" placeholder="<?php echo e(trans('separate_with_a_comma')); ?> e.g laravel,script">
                            <div class="invalid-feedback"></div>
                        </div>
                        <div class="col-sm-12">
                        ...
                        <div class="col-sm-12">
                            ...
                            <input type="text" name="tags" id="tags" data-role="tagsinput" placeholder="<?php echo e(trans('tags')); ?> e.g Design">
                            <div class="invalid-feedback"></div>
                        </div>
                        <div class="col-sm-12">
                    ...
                    <div class="d-flex pt-5">
                        <button type="submit" id="addpost_btn" class="btn btn-mint me-3"><?php echo e(trans('submit')); ?></button>
                    </div>
                </form>
...
<script>
    ...
    $(function() {
        ...
        $(document).on('submit', '#addpost_form', function(e) {
            ...
            $("#addpost_btn").text('<?php echo e(trans('submitting')); ?>...');
            ...
            $.ajax({
                    method: 'POST',
                    url: '<?php echo e(route('user.posts.add')); ?>',
                    data: fd,
                    cache: false,
                    contentType: false,
                    processData: false,
                    ...
                    success: function(response) {
                        ...
                        if (response.status == 400) {
                            ...
                            $("#addpost_btn").text('<?php echo e(trans('submit')); ?>');
                            ...
                            window.location = '<?php echo e(route('user.posts.list')); ?>';
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\projects\Tests\ApexForum\resources\views/user/posts/add.blade.php ENDPATH**/ ?>