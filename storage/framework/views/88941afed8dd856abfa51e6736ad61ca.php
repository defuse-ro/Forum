...
<?php $__empty_1 = true; $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
    <div class="post-box card d-flex mx-0 <?php echo e($post->solved == '1' ? 'solved' : ''); ?>" data-aos="fade-up" data-aos-easing="linear">
        ...
        <div class="post-badge"> <i class="bi bi-check2-circle"></i> Solved & <i class="bi bi-lock"></i> Closed</div>
        <?php elseif($post->solved == '1' && $post->closed == '0'): ?>
        <div class="post-badge"> <i class="bi bi-check2-circle"></i> Solved </div>
        <?php elseif($post->solved == '0' && $post->closed == '1'): ?>
        <div class="post-badge"> <i class="bi bi-lock"></i> Closed </div>
        <?php endif; ?>

        <a href="javascript:void(0)" onclick="delete_item('<?php echo e(route('user.bookmarks.destroy')); ?>','<?php echo e($post->id); ?>','Remove this Bookmark');" class="remove-icon"><i class="bi bi-x-lg"></i></a>
            ...
            <div class="card-header card-header-action">
                <div class="media align-items-center">
                        ...
                        <div class="avatar custom-tooltip">
                            ...
                            <div class="custom-tooltip-dropdown">
                                <div class="author-action d-flex flex-wrap align-items-center mb-3">
                                    ...
                                    <div class="ms-2">
                                        <span class="author-username"><?php echo e($post->user->total_points()); ?> Points</span>
                                        <span class="author-follow-text"><?php echo e($post->user->followers->count()); ?> Followers</span>
                                    </div>
                                </div>
                                ...
                                <a href="<?php echo e(route('user', ['username' => $post->user->username])); ?>" class="btn btn-sm btn-mint rounded-pill"><span>View Profile</span></a>
                            </div>
                    ...
                    <div class="media-body">
                        ...
                        <div class="fs-7"><span> <?php echo e($post->created_at->diffForHumans()); ?> in </span> <a href="<?php echo e(route('category', ['slug' => $post->category->slug])); ?>" class="cat"><?php echo e($post->category->name); ?></a></div>
                    </div>
                </div>
                    <div class="card-action-wrap">
                        <?php if($post->pinned == '1'): ?>
                            <p class="me-2 text-danger d-flex"><i class="bi bi-pin"></i> <span class="d-none d-sm-block">Pinned</span></p>
                        <?php endif; ?>
                        <?php if(Auth::check()): ?>
                        <?php if(Auth::user()->id === $post->user->id): ?>
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <?php if($post->pinned == '0'): ?>
                                    <a class="dropdown-item" href="javascript:void(0)" onclick="pin('<?php echo e(route('user.posts.pin')); ?>','<?php echo e($post->id); ?>');"><i class="bi bi-pin me-2"></i> Pin Post</a>
                                <?php elseif($post->pinned == '1'): ?>
                                    <a class="dropdown-item" href="javascript:void(0)" onclick="pin('<?php echo e(route('user.posts.unpin')); ?>','<?php echo e($post->id); ?>');"><i class="bi bi-pin me-2"></i> Unpin Post</a>
                                <?php endif; ?>
                                <?php if($post->closed == '1'): ?>
                                    <a class="dropdown-item" href="javascript:void(0)" onclick="open_post(<?php echo e($post->id); ?>)"><i class="bi bi-unlock me-2"></i> Open Post</a>
                                <?php elseif($post->closed == '0'): ?>
                                    <a class="dropdown-item" href="javascript:void(0)" onclick="close_post(<?php echo e($post->id); ?>)"><i class="bi bi-lock me-2"></i> Close Post</a>
                                <?php endif; ?>

                                <a class="dropdown-item" href="<?php echo e(route('user.posts.edit', ['id' => $post->id])); ?>"><i class="bi bi-pencil me-2"></i> Edit Post</a>
                                <a class="dropdown-item" href="javascript:void(0)" onclick="delete_item('<?php echo e(route('user.posts.destroy')); ?>','<?php echo e($post->id); ?>','Delete this Post');"><i class="bi bi-trash3 me-2"></i> Delete Post</a>
                            </div>
                        <?php endif; ?>
                        <?php endif; ?>
                    </div>
                ...
                <?php if($post->likes == '1'): ?>
                    ...
                    <?php elseif(get_setting('react_like') == 'Like'): ?>
                        <div class="qa-item">
                            ...
                            <div class="qa-text me-2">Likes</div>
...
<div class="dashboard-card" data-aos="fade-up" data-aos-easing="linear">
    <div class="dashboard-body">
        <div class="upload-image my-3">
            <h4 class="mb-3">No Bookmarks available.</h4>
        </div>
...
<div class="d-flex justify-content-center" id="user_bookmarks" data-aos="fade-up" data-aos-easing="linear">
    <?php echo $posts->appends(request()->all())->links('layouts.pagination.custom'); ?>

</div>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\projects\Tests\ApexForum\resources\views/frontend/pagination/user/bookmarks.blade.php ENDPATH**/ ?>