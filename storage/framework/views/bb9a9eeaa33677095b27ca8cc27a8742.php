            ...
            <div class="row">
                <div class="col-lg-12">
                    <ul class="breadcrumbs">
                        ...
                        <li><a href="<?php echo e(route('tags')); ?>">Tags</a></li>
                        <li><?php echo e('#'.$tag->name); ?></li>
                    </ul>
                    <h2 class="mb-2"><?php echo e('#'.$tag->name); ?></h2>
                </div>
            </div>
        </div>
    </div><!--/vine-header-->
    ...
    <div class="filter mx-0">
        ...
        <form class="form" id="search_form">
            ...
            <div class="filter-toolbar">
                <input type="hidden" name="tag" id="tag" value="<?php echo e($tag->name); ?>">
...
<script>
    ...
    function filterPosts() {
        ...
        let url = "<?php echo e(route('tag.posts.sort')); ?>";
        $.ajax({
            type: "get",
            url: url,
            data: {
    ...
    function fetchData(page, category_id, date, sort, search_term, tag) {
        ...
        $.ajax({
            url: "<?php echo e(url('tag/posts/pagination/?page=')); ?>" + page,
            data: {
                'category_id': category_id,
                'date': date,
                'sort': sort,
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\projects\Tests\ApexForum\resources\views/frontend/tag.blade.php ENDPATH**/ ?>